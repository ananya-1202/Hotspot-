...
#print(cv2.imwrite(r"img" + str(1)  + ".jpg", subimg))
...
print(cv2.imwrite(r"Test\hotspot" + ".jpg", imgsave))
...
#print(cv2.imwrite(r"sample\img.jpg", imgsave))
...
result = cv2.VideoWriter(r"\video.avi",  cv2.VideoWriter_fourcc(*'MJPG'), 10, size)
